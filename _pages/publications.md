...
<style>
  /* Hide heading generated automatically by the page layout */
  .post-header {
    display: none;
  }

  /* Match the Patents page width */
  .container[role="main"] {
    width: 86%;
    max-width: 1320px;
  }
  ...
  /* Same year/content grid and spacing as Patents */
  ...
  /* Same secondary line scale as Patents */
