...
<div class="research-page">
  ...
  <section class="research-section">
    ...
    <figure class="research-figure">
      ...
      <figcaption class="research-caption">
        <strong>STRUCTURAL CONTROL IN MOFs</strong><br>
  ...
  <section class="research-section">
    ...
    <figure class="research-figure">
      ...
      >
      <figcaption class="research-caption">
        <strong>STIMULUS-RESPONSIVE MATERIALS</strong><br>
        Functional ligand structures and stimulus-induced molecular changes
        within coordination solids.
      </figcaption>
    </figure>
  </section>
  ...
  <section class="research-section">
    ...
    <figure class="research-figure">
      ...
      >
      <figcaption class="research-caption">
        <strong>MOLECULAR-TO-SOLID FUNCTION</strong><br>
        Connecting molecular structure, coordination, packing, and crystalline
        material function.
      </figcaption>
    </figure>
  </section>
  ...
  <section class="research-section">
    ...
    <figure class="research-figure">
      ...
      >
      <figcaption class="research-caption">
        <strong>DATA-DRIVEN MATERIALS DESIGN</strong><br>
        Experimental structure–function data, computational prediction, and
        validation of candidate materials.
      </figcaption>
    </figure>
  </section>
</div>
